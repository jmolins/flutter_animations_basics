...
class AnimatedHome7 extends StatefulWidget {
  @override
  _AnimatedHomeState createState() => _AnimatedHomeState();
}

class _AnimatedHomeState extends State<AnimatedHome7>
    with SingleTickerProviderStateMixin<AnimatedHome7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Curved animations")),
      body: Align(
